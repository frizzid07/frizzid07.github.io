    ...
    <Fade bottom duration={1000} distance="20px">
      ...
      <div className="row">
        <div className="main-content-profile">
            ...
            <h2 className="bio-text">"{ emoji("Wish to be associated with an organization that offers a positive atmosphere to learn and implement useful skills and technologies for the betterment of the industry") }"</h2>
              {prof.location !== null &&
